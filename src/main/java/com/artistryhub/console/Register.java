...
public class Register {
	public static void main(String[] args) {
		...
		facade.createPresentation("15/08/2025", "Lucas", "Sao Paulo", 150.00, 120, 8000, 10000);
		facade.createPresentation("20/08/2025", "Ana", "Rio de Janeiro", 200.00, 90, 7000, 9000);
		facade.createPresentation("25/08/2025", "Pedro", "Belo Horizonte", 100.00, 110, 5000, 7000);
		facade.createPresentation("30/08/2025", "Maria", "Salvador", 180.00, 130, 6000, 8000);
		facade.createPresentation("05/09/2025", "Joao", "Porto Alegre", 120.00, 100, 4000, 5000);
		facade.createPresentation("12/09/2025", "Joao", "Porto Alegre", 160.00, 100, 4000, 5000);
		facade.createPresentation("12/09/2025", "Carlos", "Porto Alegre", 160.00, 100, 4000, 5000);
		facade.createPresentation("10/09/2025", "Carlos", "Curitiba", 250.00, 140, 9000, 10000);
		facade.createPresentation("15/09/2025", "Beatriz", "Brasilia", 130.00, 90, 3000, 4000);
		facade.createPresentation("20/09/2025", "Fernanda", "Fortaleza", 220.00, 100, 7500, 8000);
		facade.createPresentation("25/09/2025", "Ricardo", "Recife", 80.00, 80, 2000, 3000);
		facade.createPresentation("30/09/2025", "Juliana", "Manaus", 90.00, 70, 1500, 2500);
		facade.createPresentation("05/10/2025", "Gustavo", "Sao Paulo", 170.00, 110, 6000, 7000);
		facade.createPresentation("10/10/2025", "Camila", "Rio de Janeiro", 160.00, 100, 4500, 6000);
		facade.createPresentation("15/10/2025", "Bruno", "Belo Horizonte", 140.00, 120, 5000, 7000);
		facade.createPresentation("20/10/2025", "Larissa", "Salvador", 200.00, 80, 5500, 6000);
		facade.createPresentation("21/10/2025", "Larissa", "Recife", 200.00, 80, 5500, 6000);
		facade.createPresentation("25/10/2025", "Felipe", "Porto Alegre", 110.00, 90, 2500, 4000);
		facade.createPresentation("30/10/2025", "Renata", "Curitiba", 300.00, 130, 7000, 8000);
		facade.createPresentation("05/11/2025", "Leonardo", "Brasilia", 180.00, 140, 6000, 9000);
		facade.createPresentation("10/11/2025", "Sofia", "Fortaleza", 150.00, 110, 4500, 6000);
		facade.createPresentation("10/11/2025", "Mateus", "Recife", 130.00, 100, 3000, 5000);
		facade.createPresentation("20/11/2025", "Isabela", "Manaus", 170.00, 90, 4000, 5000);
